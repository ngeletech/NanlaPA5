...
$pageScript = '/NanlaPA5/app/js/travel-agency/group-trips.js';
...
<main class="main">
    <div class="container">
        <div class="page-header">
            ...
            <button class="btn-primary" onclick="openCreateModal()">+ Create group trip</button>
        </div>
        ...
        <div class="stats-grid stats-grid-3">
            <div class="stat-card">
                <span class="stat-num" id="stat-total-trips">—</span>
                <span class="stat-label">Total group trips</span>
            </div>
            <div class="stat-card">
                <span class="stat-num" id="stat-open-trips">—</span>
                <span class="stat-label">Open for joining</span>
            </div>
            <div class="stat-card">
                <span class="stat-num" id="stat-total-participants">—</span>
        ...
        <!-- Create/Edit group trip modal -->
        <div class="modal-overlay" id="gt-modal" style="display:none;">
            <div class="modal">
                <h3 class="modal-title" id="gt-modal-title">Create group trip</h3>
                <div class="form-group">
                    <label for="gt-package-select">Package</label>
                    <select id="gt-package-select" class="form-control">
                        <option value="">Select a package...</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="gt-traveller">Traveller</label>
                    <select id="gt-traveller" class="form-control">
                        <option value="">Select a traveller...</option>
                    </select>
                </div>
                <div class="form-actions">
                    <button class="btn-outline" onclick="closeGroupTripModal()">Cancel</button>
                    <button class="btn-primary" onclick="saveGroupTrip()">Save</button>
                </div>
            </div>
        </div>
    </div>
