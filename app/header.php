...
<nav class="navbar">
  ...
  <?php if ($isLoggedIn && $userType === 'traveller'): ?>
    <ul class="nav-links">
      ...
      <li><a href="/NanlaPA5/app/traveller/packages.php"> Compare Packages</a></li>
      <li><a href="/NanlaPA5/app/traveller/mybookings.php">My Bookings</a></li>
    </ul>
    <div class="nav-actions">
      ...
      <a href="/NanlaPA5/app/logout.php" class="btn-logout">Log out</a>
    </div>

  <?php elseif ($isLoggedIn && $userType === 'agency'): ?>
    <ul class="nav-links">
      <li><a href="/NanlaPA5/app/travel-agency/packages.php">My Packages</a></li>
      <li><a href="/NanlaPA5/app/travel-agency/group-trips.php">Group Trips</a></li>
    </ul>
    <div class="nav-actions">
      <a href="/NanlaPA5/app/travel-agency/profile.php" class="nav-profile">
