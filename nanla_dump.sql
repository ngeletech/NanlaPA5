...
(1,'Romantic Paris Escape',1500,'2026-06-01','2026-06-07','7 Days in Paris with museum tours.',10,11),
(2,'Tokyo Highlights',2500,'2026-04-10','2026-04-18','Experience Tokyo history and modern life.',15,12),
(3,'Cape Town Adventure',1800,'2026-07-15','2026-07-25','Explore Table Mountain and Vineyards.',12,13),
(4,'NYC City Lights',1100,'2026-09-20','2026-09-24','Broadway and Statue of Liberty tours.',20,14),
(5,'Ultimate Sydney Tour',3300,'2026-12-05','2026-12-15','Opera house entry and coastal cruising.',8,15),
(6,'Classic Rome Heritage',1600,'2026-06-15','2026-06-22','Colosseum and Vatican guide package.',15,16),
(7,'Ancient Wonders Egypt',1200,'2026-11-12','2026-11-19','Pyramids, Sphinx and Nile cruises.',25,17),
(8,'Bangkok Culture Tour',900,'2026-01-20','2026-01-26','Temples and street food expeditions.',30,18),
(9,'Historic London Tour',1750,'2026-07-01','2026-07-08','Tower of London exploration stay.',14,19),
(10,'Rio Carnival Special',2100,'2026-02-18','2026-02-24','VIP access to world famous festival.',50,20),
(11,'Luxury Dubai Escape',2800,'2026-03-05','2026-03-11','High life in the modern desert wonderland.',12,11),
(12,'Icelandic Wonders',2200,'2026-01-15','2026-01-22','Chasing auroras and Blue Lagoon relaxation.',16,12),
(13,'Inca Discovery',1500,'2026-05-22','2026-05-30','Trek to Machu Picchu sacred ruins.',10,13),
(14,'Discover Toronto',850,'2026-07-10','2026-07-14','CN tower view and urban discovery.',20,14),
(15,'Mumbai Dynamic Beats',1300,'2026-11-25','2026-12-02','Bollywood tours and ocean drive nights.',18,15),
(16,'Barcelona Architecture',1450,'2026-08-02','2026-08-09','Gaudi masterpiece walks and beaches.',15,16),
(17,'Auckland Explorer',3100,'2026-12-12','2026-12-22','Sailing tours and volcanic climbs.',10,17),
(18,'Wild Kenya Safari',2500,'2026-09-05','2026-09-12','Big Five national park game safaris.',8,18),
(19,'Marrakesh Nights',1150,'2026-04-14','2026-04-20','Spices, souks, and historic riad stays.',12,19),
(20,'Bali Tropical Paradise',1600,'2026-08-20','2026-08-28','Temple sunset tours and beach resorts.',15,20);
...
-- Dump completed on 2026-05-23 16:53:45
